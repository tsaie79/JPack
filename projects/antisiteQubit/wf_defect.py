...
class ZPLWF:
    def __init__(self, from_db_entry, prev_calc_dir, spin_config):
        ...
        try:
            ...
            self.structure = Structure.from_dict(from_db_entry["output"]["structure"])
...
class Cluster:
    ...
    def wf(self):
        ...
        wf = add_additional_fields_to_taskdocs(wf, {"structure_file_name": "pristine_cluster_2021-11-23.vasp"})
