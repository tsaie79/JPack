#%% lattice relax and structure relax
import numpy as np
...
# st = Structure.from_file("/home/tug03990/scratch/copper_graphene/modeling/cu-graphene-c-head.vasp")
...
override_default_vasp_params={
    "user_incar_settings": {"EDIFF":1E-5, "EDIFFG":-0.01, "ISIF":2, "SIGMA":0.1, "ISPIN":1},
    "vdw": "df"}
# override_default_vasp_params={
...
wf = add_additional_fields_to_taskdocs(wf, {"stacking":"head"})
...
wf = Workflow(fws, name="{}:head".format(st.formula))
